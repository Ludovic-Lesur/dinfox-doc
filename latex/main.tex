...
\begin{document}
    ...
    \begin{table}[h]
        ...
        \begin{tabular}{|p{9mm}|p{18.4mm}|p{18.4mm}|p{18.4mm}|p{18.4mm}|p{18.4mm}|p{18.4mm}|p{18.4mm}|}
            ...
            \tl\centering\tdvl{1.2} & \centering\swvm{una-lib}{4.0} & \centering\swvm{una-at}{5.0} & \centering\swvm{una-r4s8cr}{1.0} & \centering\swvm{lmac-driver}{3.0} & \centering\swvl{dinfox-registers}{4.0} & \centering\swvl{dmm}{6.10} & \centering\swvl{dsm}{7.13} \tabularnewline
            \tl\centering\tdvl{1.3} & \centering\swvm{una-lib}{4.0} & \centering\swvm{una-at}{5.0} & \centering\swvm{una-r4s8cr}{1.0} & \centering\swvm{lmac-driver}{3.0} & \centering\swvm{dinfox-registers}{6.0} & \centering\swvm{dmm}{7.0} & \centering\swvm{dsm}{8.3} \tabularnewline
            \hline
        \end{tabular}
    \end{table}
