...
\rft {
    \rfu {31$\,-\,$10} {22} {0b0[22]}
    \rff {9} {1} {ESF} {$ - $} {MCU error stack flag.} {\textbf{0b0} : error stack is empty. \\ \textbf{0b1} : error stack is not empty.}
...
\rmt
{\rmu{4}{|c} & \rmf{12}{|c|}{MCU\_TEMPERATURE[11:0]}}
{\rmf{16}{|c|}{MCU\_VOLTAGE[15:0]}}

\rft {
    \rfu {31$\,-\,$28} {4} {0b0000}
    \rff {27$\,-\,$16} {12} {MCU\_TEMPERATURE} {0x7FF} {MCU internal temperature.} {\reflink{Table}{temperature-representation}}
    \rff {15$\,-\,$0} {16} {MCU\_VOLTAGE} {0xFFFF} {MCU supply voltage.} {\reflink{Table}{voltage-representation}}
}
...
\rmt
{\rmu{16}{|c|}}
{\rmu{14}{|c} & \rmf{1}{|c|}{RCFH} & \rmf{1}{|c|}{BMSF}}

\rft {
    \rfu {31$\,-\,$2} {30} {0b0[30]}
    \rff {1} {1} {RCFH} {$ - $} {Relay control mode (set at compilation step according to hardware).} {\textbf{0b0} : Relay controlled by the MCU. \\ \textbf{0b1} : Relay controlled by hardware.}
...
\rmt
{\rmf{16}{|c|}{BMS\_INPUT\_VOLTAGE\_THH}}
{\rmf{16}{|c|}{BMS\_INPUT\_VOLTAGE\_THL}}

\rft {
    \rff {31$\,-\,$16} {16} {BMS\_INPUT\_VOLTAGE\_THH} {$ - $} {High input voltage threshold of the BMS hysteresis.} {\reflink{Table}{voltage-representation}}
    \rff {15$\,-\,$0} {16} {BMS\_INPUT\_VOLTAGE\_THL} {$ - $} {Low input voltage threshold of the BMS hysteresis.} {\reflink{Table}{voltage-representation}}
}
...
\rmt
{\rmu{16}{|c|}}
{\rmf{16}{|c|}{OUTPUT\_CURRENT\_OFFSET[15:0]}}

\rft {
    \rfu {31$\,-\,$16} {16} {0x0000}
    \rff {15$\,-\,$0} {16} {OUTPUT\_CURRENT\_OFFSET} {$ - $} {Output current offset calibration value.} {\reflink{Table}{current-representation}}
}
...
\rmt
{\rmu{16}{|c|}}
{\rmu{14}{|c} & \rmf{2}{|c|}{RCS}}

\rft {
    \rfu {31$\,-\,$2} {30} {0b0[30]}
    \rff {1$\,-\,$0} {2} {RCS} {0b11} {Relay control state.} {\reflink{Table}{bit-representation} \\ \textbf{0b00} : NC or R path closed. \\ \textbf{0b01} : NO or S path closed.}
}
{Status register 1}
{LVRM-SR1}
...
\rft {
    \rfu {31$\,-\,$1} {31} {0b0[31]}
    \rff {0} {1} {RC} {0b0} {Relay control.} {\textbf{0b0} : close NC or R path. \\ \textbf{0b1} : close NO or S path.}
}
{Control register 1}
{LVRM-CR1}
...
\rmt
{\rmf{16}{|c|}{OUTPUT\_VOLTAGE[15:0]}}
{\rmf{16}{|c|}{INPUT\_VOLTAGE[15:0]}}

\rft {
    \rff {31$\,-\,$16} {16} {OUTPUT\_VOLTAGE} {0xFFFF} {Relay output voltage.} {\reflink{Table}{voltage-representation}}
    \rff {15$\,-\,$0} {16} {INPUT\_VOLTAGE} {0xFFFF} {Relay common input voltage.} {\reflink{Table}{voltage-representation}}
}
...
\rmt
{\rmu{16}{|c|}}
{\rmf{16}{|c|}{OUTPUT\_CURRENT[15:0]}}

\rft {
    \rfu {31$\,-\,$16} {16} {0x0000}
    \rff {15$\,-\,$0} {16} {OUTPUT\_CURRENT} {0xFFFF} {Relay output current.} {\reflink{Table}{current-representation}}
}
...
\rmt
{\rmu{16}{|c|}}
{\rmu{12}{|c} & \rmf{1}{|c}{BKFH} & \rmu{1}{|c} & \rmf{1}{|c}{CSFH} & \rmf{1}{|c|}{CCFH}}
...
\rft {
    ...
    \rff {0} {1} {CCFH} {$ - $} {Charge control mode (set at compilation step according to hardware).} {\textbf{0b0} : Charge controlled by the MCU. \\ \textbf{0b1} : Charge controlled by hardware.}
}
{Flags register 1}
{BPSM-FR1}
...
\rmt
{\rmu{8}{|c} & \rmf{8}{|c|}{CHARGE\_TOGGLE\_PERIOD}}
{\rmf{16}{|c|}{CHARGE\_SOURCE\_VOLTAGE\_TH}}

\rft {
    \rfu {31$\,-\,$24} {8} {0x00}
    \rff {23$\,-\,$16} {8} {CHARGE\_TOGGLE\_PERIOD} {$ - $} {Charge toggle period (LTC4079 latch-off workaround).} {\reflink{Table}{time-representation}}
    \rff {15$\,-\,$0} {16} {CHARGE\_SOURCE\_VOLTAGE\_TH} {$ - $} {Minimum source voltage required to set the \texttt{CHEN} bit.} {\reflink{Table}{voltage-representation}}
}
{Configuration register 0}
{BPSM-CFGR0}

\textbf{\underline{Note:}} this register is only used when \texttt{CHMD = 0b1} and \texttt{CCFH = 0b0}.

\paragraph{Configuration register 1}

\rmt
{\rmf{16}{|c|}{LVF\_STORAGE\_VOLTAGE\_THH}}
{\rmf{16}{|c|}{LVF\_STORAGE\_VOLTAGE\_THL}}

\rft {
    \rff {31$\,-\,$16} {16} {LVF\_STORAGE\_VOLTAGE\_THH} {$ - $} {High storage voltage threshold of the LVF hysteresis.} {\reflink{Table}{voltage-representation}}
    \rff {15$\,-\,$0} {16} {LVF\_STORAGE\_VOLTAGE\_THL} {$ - $} {Low storage voltage threshold of the LVF hysteresis.} {\reflink{Table}{voltage-representation}}
}
{Configuration register 1}
{BPSM-CFGR1}
...
\rmt
{\rmf{16}{|c|}{CVF\_STORAGE\_VOLTAGE\_THH}}
{\rmf{16}{|c|}{CVF\_STORAGE\_VOLTAGE\_THL}}

\rft {
    \rff {31$\,-\,$16} {16} {CVF\_STORAGE\_VOLTAGE\_THH} {$ - $} {High storage voltage threshold of the CVF hysteresis.} {\reflink{Table}{voltage-representation}}
    \rff {15$\,-\,$0} {16} {CVF\_STORAGE\_VOLTAGE\_THL} {$ - $} {Low storage voltage threshold of the CVF hysteresis.} {\reflink{Table}{voltage-representation}}
}
...
\rmt
{\rmu{16}{|c|}}
{\rmu{6}{|c} & \rmf{1}{|c}{CVF} & \rmf{1}{|c}{LVF} &  \rmu{2}{|c} & \rmf{2}{|c}{CHST} & \rmf{2}{|c}{CHCS} & \rmf{2}{|c|}{BKCS}}
...
\rft {
    ...
    \rfu {7$\,-\,$6} {2} {0b00}
    \rff {5$\,-\,$4} {2} {CHST} {0b11} {Storage element charging status.} {\reflink{Table}{bit-representation} \\ \textbf{0b00} : charge pending. \\ \textbf{0b01} : charge complete.}
    \rff {3$\,-\,$2} {2} {CHCS} {0b11} {Storage element charging control state.} {\reflink{Table}{bit-representation} \\ \textbf{0b00} : charge disabled. \\ \textbf{0b01} : charge enabled.}
    \rff {1$\,-\,$0} {2} {BKCS} {0b11} {Backup output control state.} {\reflink{Table}{bit-representation} \\ \textbf{0b00} : backup output disabled. \\ \textbf{0b01} : backup output enabled.}
}
{Status register 1}
{BPSM-SR1}
...
\rmt
{\rmf{16}{|c|}{STORAGE\_VOLTAGE[15:0]}}
{\rmf{16}{|c|}{SOURCE\_VOLTAGE[15:0]}}

\rft {
    \rff {31$\,-\,$16} {16} {STORAGE\_VOLTAGE} {0xFFFF} {Storage element voltage.} {\reflink{Table}{voltage-representation}}
    \rff {15$\,-\,$0} {16} {SOURCE\_VOLTAGE} {0xFFFF} {Input source voltage.} {\reflink{Table}{voltage-representation}}
}
{Analog data register 1}
{BPSM-ADR1}
...
\rmt
{\rmu{16}{|c|}}
{\rmf{16}{|c|}{BACKUP\_VOLTAGE[15:0]}}

\rft {
    \rfu {31$\,-\,$16} {16} {0x0000}
    \rff {15$\,-\,$0} {16} {BACKUP\_VOLTAGE} {0xFFFF} {Backup output voltage.} {\reflink{Table}{voltage-representation}}
}
{Analog data register 2}
{BPSM-ADR2}
...
\rmt
{\rmu{16}{|c|}}
{\rmu{15}{|c} & \rmf{1}{|c|}{RCFH}}

\rft {
    \rfu {31$\,-\,$1} {31} {0b0[31]}
    \rff {0} {1} {RCFH} {$ - $} {DC$-$DC control mode (set at compilation step according to hardware).} {\textbf{0b0} : DC$-$DC controlled by the MCU. \\ \textbf{0b1} : DC$-$DC controlled by hardware.}
}
{Flags register 1}
{DDRM-FR1}
...
\rft {
    \rfu {31$\,-\,$2} {30} {0b0[30]}
    \rff {1$\,-\,$0} {2} {RCS} {0b11} {DC$-$DC converter control state.} {\reflink{Table}{bit-representation} \\ \textbf{0b00} : DC$-$DC output disabled. \\ \textbf{0b01} : DC$-$DC output enabled.}
}
{Status register 1}
{DDRM-SR1}
...
\rft {
    \rfu {31$\,-\,$1} {31} {0b0[31]}
    \rff {0} {1} {REN} {0b0} {DC$-$DC converter control.} {\textbf{0b0} : disable DC$-$DC output \\ \textbf{0b1} : enable DC$-$DC output.}
}
{Control register 1}
{DDRM-CR1}
...
\rft {
    \rff {31$\,-\,$16} {16} {OUTPUT\_VOLTAGE} {0xFFFF} {DC$-$DC converter output voltage.} {\reflink{Table}{voltage-representation}}
    \rff {15$\,-\,$0} {16} {INPUT\_VOLTAGE} {0xFFFF} {DC$-$DC converter input voltage.} {\reflink{Table}{voltage-representation}}
}
{Analog data register 1}
{DDRM-ADR1}
...
\rft {
    \rfu {31$\,-\,$16} {16} {0x0000}
    \rff {15$\,-\,$0} {16} {OUTPUT\_CURRENT} {0xFFFF} {DC$-$DC converter output current.} {\reflink{Table}{current-representation}}
}
{Analog data register 2}
{DDRM-ADR2}
...
\rtt {
    ...
    \rtl {0x0A} {CONFIGURATION\_1} {32} {R/W} {UHFM-CFGR1} {Sigfox timings parameters.}
    \rtl {0x0B} {STATUS\_1} {32} {R} {UHFM-SR1} {Modem status.}
    \rtl {0x0C} {CONTROL\_1} {32} {R/W} {UHFM-CR1} {Modem control.}
    \rtl {0x0D} {CONTROL\_2} {32} {R/W} {UHFM-CR2} {Modem control.}
    \rtl {0x0E} {ANALOG\_DATA\_1} {32} {R} {UHFM-ADR1} {$ V_{RF} $ voltage measurement.}
    \rtl {0x0F} {SIGFOX\_EP\_ID} {32} {R} {UHFM-SEPID} {Sigfox end-point ID.}
    \rtl {0x10} {SIGFOX\_UL\_PAYLOAD\_0} {32} {R/W} {UHFM-SULP0} {Sigfox UL payload bytes 0 to 3.}
    \rtl {0x11} {SIGFOX\_UL\_PAYLOAD\_1} {32} {R/W} {UHFM-SULP1} {Sigfox UL payload bytes 4 to 7.}
    \rtl {0x12} {SIGFOX\_UL\_PAYLOAD\_2} {32} {R/W} {UHFM-SULP2} {Sigfox UL payload bytes 8 to 11.}
    \rtl {0x13} {SIGFOX\_DL\_PAYLOAD\_0} {32} {R} {UHFM-SDLP0} {Sigfox DL payload bytes 0 to 3.}
    \rtl {0x14} {SIGFOX\_DL\_PAYLOAD\_1} {32} {R} {UHFM-SDLP1} {Sigfox DL payload bytes 4 to 7.}
}
...
\rmt
{\rmu{16}{|c|}}
{\rmf{2}{|c}{SNFR[1:0]} & \rmf{1}{|c}{SBR} & \rmf{3}{|c}{SIGFOX\_RC[2:0]} & \rmf{1}{|c}{RFBY} & \rmf{1}{|c}{RLBY} & \rmf{8}{|c|}{SIGFOX\_TX\_POWER[7:0]}}

\rft {
    \rfu {31$\,-\,$16} {16} {0x0000}
    \rff {15$\,-\,$14} {2} {SNFR} {0b11} {Number of frame(s) per Sigfox uplink message (N).} {\textbf{0b00} : \textcolor{Green}{reserved for future use} \\ \textbf{0b01} : 1 frame (N=1) \\ \textbf{0b10} : 2 frames (N=2) \\ \textbf{0b11} : 3 frames (N=3)}
    \rff {13} {1} {SBR} {0b1} {Sigfox signal bit rate.} {\textbf{0b0} : $ 100\,bps $ \\ \textbf{0b1} : $ 600\,bps $}
    \rff {12$\,-\,$10} {4} {SIGFOX\_RC} {0b000} {Sigfox radio configuration zone.} {\textcolor{DarkOrchid}{\textbf{HW1.0}} \\ \textcolor{Red}{Fixed to 0b000 by software.}  \\ \vspace*{1mm} \textcolor{DarkOrchid}{\textbf{HW2.0}} \\ \textbf{0b000} : RC1 \\ \textbf{0b001} : RC2 \\ \textbf{0b010} : RC3 \\ \textbf{0b011} : RC4 \\ \textbf{0b100} : RC5 \\ \textbf{0b101} : RC6 \\ \textbf{0b110} : RC7 \\ \textbf{0b111} : \textcolor{Green}{reserved for future use}}
    \rff {9} {1} {RFBY} {0b0} {RX filter bypass.} {\textcolor{DarkOrchid}{\textbf{HW1.0}} \\ \textcolor{Red}{Fixed to 0b0 by hardware.} \\ \vspace*{1mm} \textcolor{DarkOrchid}{\textbf{HW2.0}} \\ \textbf{0b0} : Use SAW filter in radio reception mode. \\ \textbf{0b1} : Bypass SAW filter in radio reception mode.}
    \rff {8} {1} {RLBY} {0b0} {RX LNA bypass.} {\textcolor{DarkOrchid}{\textbf{HW1.0}} \\ \textcolor{Red}{Fixed to 0b0 by hardware.} \\ \vspace*{1mm} \textcolor{DarkOrchid}{\textbf{HW2.0}} \\ \textbf{0b0} : Use low noise amplifier in radio reception mode. \\ \textbf{0b1} : Bypass low noise amplifier in radio reception mode.}
    \rff {7$\,-\,$0} {8} {SIGFOX\_TX\_POWER} {0xBC} {Sigfox transmission power.} {\reflink{Table}{rf-power-representation} \\ \vspace*{1mm} \textcolor{DarkOrchid}{\textbf{HW1.0}} \\ \textcolor{Red}{Fixed to $14\,dBm$ by software.} \\ \vspace*{1mm} \textcolor{DarkOrchid}{\textbf{HW2.0}} \\ $0\,-\,$14$\,dBm$ ($150\,-\,960\,MHz$) \\ $0\,-\,$22$\,dBm$ ($860\,-\,930\,MHz$)}
}
{Configuration register 0}
{UHFM-CFGR0}

\bigskip
\textbf{\underline{Note:}} The Sigfox RC3 zone is implemented with the low duty cycle (LDC) spectrum access method.
\medskip \\
\textbf{\underline{Note:}} The SAW filter is centered on $869\,MHz$ (\textbf{B3725} on HW1.0, \textbf{B2636} on HW2.0).
...
\rmt
{\rmf{16}{|c|}{SIGFOX\_T\_CONF[15:0]}}
{\rmf{16}{|c|}{SIGFOX\_T\_IFU[15:0]}}

\rft {
    \rff {31$\,-\,$16} {16} {SIGFOX\_T\_CONF} {0x07D0} {Delay between Sigfox downlink reception and confirmation frame transmission.} {\textbf{Raw} value in $ ms $ \\ \vspace*{1mm} \textcolor{DarkOrchid}{\textbf{HW1.0}} \\ \textcolor{Red}{Fixed to $2000\,ms$ by software.} \\ \vspace*{1mm} \textcolor{DarkOrchid}{\textbf{HW2.0}} \\ $1400-2000\,ms$}
    \rff {15$\,-\,$0} {16} {SIGFOX\_T\_IFU} {0x03E8} {Delay between Sigfox uplink frames.} {\textbf{Raw} value in $ ms $ \\ \vspace*{1mm} \textcolor{DarkOrchid}{\textbf{HW1.0}} \\ \textcolor{Red}{Fixed to $1000\,ms$ by software.} \\ \vspace*{1mm} \textcolor{DarkOrchid}{\textbf{HW2.0}} \\ $0-2000\,ms$}
}
{Configuration register 1}
{UHFM-CFGR1}
...
\rmt
{\rmu{4}{|c} & \rmf{12}{|c|}{SIGFOX\_BIDIRECTIONAL\_MC[11:0]}}
{\rmf{8}{|c}{SIGFOX\_DL\_RSSI[7:0]} & \rmf{8}{|c|}{SIGFOX\_MESSAGE\_STATUS[7:0]}}

\rft {
    \rfu {31$\,-\,$28} {4} {0x0}
    \rff {27$\,-\,$16} {12} {SIGFOX\_BIDIRECTIONAL\_MC} {$ - $} {Message counter of the last Sigfox uplink with bidirectional request.} {\textbf{Raw} value.}
    \rff {15$\,-\,$8} {8} {SIGFOX\_DL\_RSSI} {0x00} {RSSI of the last Sigfox downlink message received.} {\reflink{Table}{rf-power-representation}}
    \rff {7$\,-\,$0} {8} {SIGFOX\_MESSAGE\_STATUS} {0x00} {Sigfox message transmission status.} {See \href{https://github.com/sigfox-tech-radio/sigfox-ep-lib/blob/master/inc/sigfox_ep_api.h}{sigfox\_ep\_api.h} file of \\ Sigfox End-Point Library.}
}
{Status register 1}
{UHFM-SR1}
...
\rmt
{\rmu{7}{|c} & \rmf{8}{|c}{CW\_TX\_POWER[7:0]} & \rmf{1}{|c|}{CWEN}}
{\rmf{4}{|c}{SIGFOX\_RFP\_TEST\_MODE[4:0]} & \rmf{1}{|c}{TTRG} & \rmf{5}{|c}{SIGFOX\_UL\_PAYLOAD\_SIZE[4:0]} & \rmf{1}{|c}{SBF} & \rmf{3}{|c}{SIGFOX\_MSGT[2:0]} & \rmf{1}{|c}{SCMF} & \rmf{1}{|c|}{STRG}}

\rft {
    \rfu {31$\,-\,$17} {15} {0b0[15]}
    \rff {24$\,-\,$17} {8} {CW\_TX\_POWER} {0xBC} {Continuous wave transmission power.} {\reflink{Table}{rf-power-representation} \\ \vspace*{1mm} \textcolor{DarkOrchid}{\textbf{HW1.0}} \\ \textcolor{Red}{Fixed to $14\,dBm$ by software.} \\ \vspace*{1mm} \textcolor{DarkOrchid}{\textbf{HW2.0}} \\ $0\,-\,$14$\,dBm$ ($150\,-\,960\,MHz$) \\ $0\,-\,$22$\,dBm$ ($860\,-\,930\,MHz$)}
    \rff {16} {1} {CWEN} {0b0} {Continuous wave control.} {\textbf{0b0} : Stop continuous wave (W) or continuous wave stopped (R). \\ \textbf{0b1} : Start continuous wave (W) or continuous wave running (R).}
    \rff {15$\,-\,$12} {4} {SIGFOX\_RFP\_TEST\_MODE} {0b0000} {Sigfox RFP Addon test mode reference.} {See \href{https://github.com/sigfox-tech-radio/sigfox-ep-addon-rfp/blob/master/inc/sigfox_ep_addon_rfp_api.h}{sigfox\_ep\_addon\_rfp\_api.h} file of Sigfox RFP Addon.}
    \rff {11} {1} {TTRG} {0b0} {Sigfox RFP Addon test mode trigger.} {\textbf{0b0} : no action (W) or no test mode pending (R). \\ \textbf{0b1} : start test mode (W) or test mode pending (R).}
    \rff {10$\,-\,$6} {5} {SIGFOX\_UL\_PAYLOAD\_SIZE} {0b00000} {Sigfox uplink payload size.} {\textbf{Raw} value in bytes \\ (0 to 12 for protocol V1)}
    \rff {5} {1} {SBF} {0b0} {Sigfox bidirectional flag.} {\textbf{0b0} : uplink only \\ \textbf{0b1} : uplink with downlink request}
    \rff {4$\,-\,$2} {3} {SIGFOX\_MSGT} {0b000} {Sigfox application message type (\texttt{CMSG}$\,=0$) \\ or Sigfox control message type (\texttt{CMSG}$\,=1$).} {See \href{https://github.com/sigfox-tech-radio/sigfox-ep-lib/blob/master/inc/sigfox_types.h}{sigfox\_types.h} file of \\ Sigfox End-Point Library.}
    \rff {1} {1} {SCMF} {0b0} {Sigfox Control message flag.} {\textcolor{DarkOrchid}{\textbf{HW1.0}} \\ \textcolor{Red}{Fixed to 0b0 by software.} \\ \vspace*{1mm} \textcolor{DarkOrchid}{\textbf{HW2.0}} \\ \textbf{0b0} : application message \\ \textbf{0b1} : control message.}
...
\medskip \\
\textbf{\underline{Note:}} Continuous wave center frequency is given by the \texttt{CONTROL\_2} register.

\newpage

\paragraph{Control register 2}

\rmt
{\rmf{16}{|c|}{CW\_RF\_FREQUENCY[31:16]}}
{\rmf{16}{|c|}{CW\_RF\_FREQUENCY[15:0]}}

\rft {
    \rff {31$\,-\,$0} {32} {CW\_RF\_FREQUENCY} {0x33AD5EC0} {Continuous wave center frequency.} {\textbf{Raw} value in $ Hz $. \\ \vspace*{1mm} \textcolor{DarkOrchid}{\textbf{HW1.0}} \\ 826$\,-\,$958$\,MHz$ \\ \vspace*{1mm} \textcolor{DarkOrchid}{\textbf{HW2.0}} \\ $150\,-\,960\,MHz$ ($\leq 14\,dBm$) \\ $860\,-\,930\,MHz$ ($> 14\,dBm$) }
}
{Control register 2}
{UHFM-CR2}
...
\rmt
{\rmf{16}{|c|}{RADIO\_RX\_VOLTAGE[15:0]}}
{\rmf{16}{|c|}{RADIO\_TX\_VOLTAGE[15:0]}}

\rft {
    \rff {31$\,-\,$16} {16} {RADIO\_RX\_VOLTAGE} {0xFFFF} {Radio front-end voltage measured in RX state.} {\reflink{Table}{voltage-representation}}
    \rff {15$\,-\,$0} {16} {RADIO\_TX\_VOLTAGE} {0xFFFF} {Radio front-end voltage measured in TX state.} {\reflink{Table}{voltage-representation}}
}
{Analog data register 1}
{UHFM-ADR1}
...
\rmt
{\rmf{8}{|c}{SIGFOX\_EP\_ID\_BYTE\_3[7:0]} & \rmf{8}{|c|}{SIGFOX\_EP\_ID\_BYTE\_2[7:0]}}
{\rmf{8}{|c}{SIGFOX\_EP\_ID\_BYTE\_1[7:0]} & \rmf{8}{|c|}{SIGFOX\_EP\_ID\_BYTE\_0[7:0]}}

\rft {
    \rff {31$\,-\,$24} {8} {SIGFOX\_EP\_ID\_BYTE\_3} {$ - $} {Byte 3 of the Sigfox end-point ID.} {$ - $}
    \rff {23$\,-\,$16} {8} {SIGFOX\_EP\_ID\_BYTE\_2} {$ - $} {Byte 2 of the Sigfox end-point ID.} {$ - $}
    \rff {15$\,-\,$8} {8} {SIGFOX\_EP\_ID\_BYTE\_1} {$ - $} {Byte 1 of the Sigfox end-point ID.} {$ - $}
    \rff {7$\,-\,$0} {8} {SIGFOX\_EP\_ID\_BYTE\_0} {$ - $} {Byte 0 of the Sigfox end-point ID.} {$ - $}
}
...
\rmt
{\rmf{8}{|c}{SIGFOX\_UL\_PAYLOAD\_BYTE\_3[7:0]} & \rmf{8}{|c|}{SIGFOX\_UL\_PAYLOAD\_BYTE\_2[7:0]}}
{\rmf{8}{|c}{SIGFOX\_UL\_PAYLOAD\_BYTE\_1[7:0]} & \rmf{8}{|c|}{SIGFOX\_UL\_PAYLOAD\_BYTE\_0[7:0]}}

\rft {
    \rff {31$\,-\,$24} {8} {SIGFOX\_UL\_PAYLOAD\_BYTE\_3} {0x00} {Byte 3 of the Sigfox uplink payload.} {$ - $}
    \rff {23$\,-\,$16} {8} {SIGFOX\_UL\_PAYLOAD\_BYTE\_2} {0x00} {Byte 2 of the Sigfox uplink payload.} {$ - $}
    \rff {15$\,-\,$8} {8} {SIGFOX\_UL\_PAYLOAD\_BYTE\_1} {0x00} {Byte 1 of the Sigfox uplink payload.}  {$ - $}
    \rff {7$\,-\,$0} {8} {SIGFOX\_UL\_PAYLOAD\_BYTE\_0} {0x00} {Byte 0 of the Sigfox uplink payload.} {$ - $}
}
...
\rmt
{\rmf{8}{|c}{SIGFOX\_UL\_PAYLOAD\_BYTE\_7[7:0]} & \rmf{8}{|c|}{SIGFOX\_UL\_PAYLOAD\_BYTE\_6[7:0]}}
{\rmf{8}{|c}{SIGFOX\_UL\_PAYLOAD\_BYTE\_5[7:0]} & \rmf{8}{|c|}{SIGFOX\_UL\_PAYLOAD\_BYTE\_4[7:0]}}

\rft {
    \rff {31$\,-\,$24} {8} {SIGFOX\_UL\_PAYLOAD\_BYTE\_7} {0x00} {Byte 7 of the Sigfox uplink payload.} {$ - $}
    \rff {23$\,-\,$16} {8} {SIGFOX\_UL\_PAYLOAD\_BYTE\_6} {0x00} {Byte 6 of the Sigfox uplink payload.} {$ - $}
    \rff {15$\,-\,$8} {8} {SIGFOX\_UL\_PAYLOAD\_BYTE\_5} {0x00} {Byte 5 of the Sigfox uplink payload.} {$ - $}
    \rff {7$\,-\,$0} {8}  {SIGFOX\_UL\_PAYLOAD\_BYTE\_4} {0x00} {Byte 4 of the Sigfox uplink payload.} {$ - $}
}
...
\rmt
{\rmf{8}{|c}{SIGFOX\_UL\_PAYLOAD\_BYTE\_11[7:0]} & \rmf{8}{|c|}{SIGFOX\_UL\_PAYLOAD\_BYTE\_10[7:0]}}
{\rmf{8}{|c}{SIGFOX\_UL\_PAYLOAD\_BYTE\_9[7:0]} & \rmf{8}{|c|}{SIGFOX\_UL\_PAYLOAD\_BYTE\_8[7:0]}}

\rft {
    \rff {31$\,-\,$24} {8} {SIGFOX\_UL\_PAYLOAD\_BYTE\_11} {0x00} {Byte 11 of the Sigfox uplink payload.} {$ - $}
    \rff {23$\,-\,$16} {8} {SIGFOX\_UL\_PAYLOAD\_BYTE\_10} {0x00} {Byte 10 of the Sigfox uplink payload.} {$ - $}
    \rff {15$\,-\,$8} {8} {SIGFOX\_UL\_PAYLOAD\_BYTE\_9} {0x00} {Byte 9 of the Sigfox uplink payload.} {$ - $}
    \rff {7$\,-\,$0} {8} {SIGFOX\_UL\_PAYLOAD\_BYTE\_8} {0x00} {Byte 8 of the Sigfox uplink payload.} {$ - $}
}
...
\rmt
{\rmf{8}{|c}{SIGFOX\_DL\_PAYLOAD\_BYTE\_3[7:0]} & \rmf{8}{|c|}{SIGFOX\_DL\_PAYLOAD\_BYTE\_2[7:0]}}
{\rmf{8}{|c}{SIGFOX\_DL\_PAYLOAD\_BYTE\_1[7:0]} & \rmf{8}{|c|}{SIGFOX\_DL\_PAYLOAD\_BYTE\_0[7:0]}}

\rft {
    \rff {31$\,-\,$24} {8} {SIGFOX\_DL\_PAYLOAD\_BYTE\_3} {0x00} {Byte 3 of the Sigfox downlink payload.} {$ - $}
    \rff {23$\,-\,$16} {8} {SIGFOX\_DL\_PAYLOAD\_BYTE\_2} {0x00} {Byte 2 of the Sigfox downlink payload.} {$ - $}
    \rff {15$\,-\,$8} {8} {SIGFOX\_DL\_PAYLOAD\_BYTE\_1} {0x00} {Byte 1 of the Sigfox downlink payload.} {$ - $}
    \rff {7$\,-\,$0} {8} {SIGFOX\_DL\_PAYLOAD\_BYTE\_0} {0x00} {Byte 0 of the Sigfox downlink payload.} {$ - $}
}
...
\rmt
{\rmf{8}{|c}{SIGFOX\_DL\_PAYLOAD\_BYTE\_7[7:0]} & \rmf{8}{|c|}{SIGFOX\_DL\_PAYLOAD\_BYTE\_6[7:0]}}
{\rmf{8}{|c}{SIGFOX\_DL\_PAYLOAD\_BYTE\_5[7:0]} & \rmf{8}{|c|}{SIGFOX\_DL\_PAYLOAD\_BYTE\_4[7:0]}}

\rft {
    \rff {31$\,-\,$24} {8} {SIGFOX\_DL\_PAYLOAD\_BYTE\_7} {0x00} {Byte 7 of the Sigfox downlink payload.} {$ - $}
    \rff {23$\,-\,$16} {8} {SIGFOX\_DL\_PAYLOAD\_BYTE\_6} {0x00} {Byte 6 of the Sigfox downlink payload.} {$ - $}
    \rff {15$\,-\,$8} {8} {SIGFOX\_DL\_PAYLOAD\_BYTE\_5} {0x00} {Byte 5 of the Sigfox downlink payload.} {$ - $}
    \rff {7$\,-\,$0} {8} {SIGFOX\_DL\_PAYLOAD\_BYTE\_4} {0x00} {Byte 4 of the Sigfox downlink payload.} {$ - $}
}
...
\rft {
    \rff {31$\,-\,$16} {16} {GEOLOC\_TIMEOUT} {$ - $} {Geo-location fix timeout.} {\textbf{Raw} value in $ s $.}
    \rff {15$\,-\,$0} {16} {TIME\_TIMEOUT} {$ - $} {Time fix timeout.} {\textbf{Raw} value in $ s $.}
}
{Configuration register 0}
{GPSM-CFGR0}
...
\rmt
{\rmf{16}{|c|}{TP\_FREQUENCY[31:16]}}
{\rmf{16}{|c|}{TP\_FREQUENCY[15:0]}}

\rft {
    \rff {31$\,-\,$0} {32} {TP\_FREQUENCY} {$ - $} {Timepulse signal frequency.} {\textbf{Raw} value in $ Hz $. \\ (1 to 10000000)}
}
{Configuration register 1}
{GPSM-CFGR1}
...
\rmt
{\rmu{16}{|c|}}
{\rmu{9}{|c} & \rmf{7}{|c|}{TP\_DUTY\_CYCLE[6:0]}}

\rft {
    \rfu {31$\,-\,$7} {25} {0b0[25]}
    \rff {6$\,-\,$0} {7} {TP\_DUTY\_CYCLE} {$ - $} {Timepulse signal duty cycle.} {\textbf{Raw} value in \% \\ (0 to 100)}
}
{Configuration register 2}
{GPSM-CFGR2}
...
\rmt
{\rmu{16}{|c|}}
{\rmu{10}{|c} & \rmf{2}{|c}{BKCS} & \rmf{1}{|c}{PWST} & \rmf{1}{|c}{TPST} & \rmf{1}{|c}{GFST} & \rmf{1}{|c|}{TFST}}

\rft {
    \rfu {31$\,-\,$6} {26} {0b0[26]}
    \rff {5$\,-\,$4} {2} {BKCS} {0b11} {GPS backup control state.} {\reflink{Table}{bit-representation} \\ \textbf{0b00} : GPS backup disabled. \\ \textbf{0b01} : GPS backup enabled.}
    ...
    \rff {1} {1} {GFST} {0b0} {GPS geo-location fix status.} {\textbf{0b0} : timeout. \\ \textbf{0b1} : success.}
    \rff {0} {1} {TFST} {0b0} {GPS time fix status.} {\textbf{0b0} : timeout. \\ \textbf{0b1} : success.}
}
{Status register 1}
{GPSM-SR1}
...
\rmt
{\rmf{16}{|c|}{ANTENNA\_VOLTAGE[15:0]}}
{\rmf{16}{|c|}{GPS\_VOLTAGE[15:0]}}

\rft {
    \rff {31$\,-\,$16} {16} {ANTENNA\_VOLTAGE} {0xFFFF} {Active antenna voltage.} {\reflink{Table}{voltage-representation}}
    \rff {15$\,-\,$0} {16} {GPS\_VOLTAGE} {0xFFFF} {GPS module voltage.} {\reflink{Table}{voltage-representation}}
}
{Analog data register 1}
{GPSM-ADR1}
...
\rft {
    \rfu {31$\,-\,$24} {12} {0x000}
    \rff {23$\,-\,$16} {8} {YEAR} {0xFF} {UTC year.} {\reflink{Table}{year-representation}}
    \rfu {15$\,-\,$12} {4} {0b0000}
...
\rmt
{\rmf{16}{|c|}{AIN1\_VOLTAGE[15:0]}}
{\rmf{16}{|c|}{AIN0\_VOLTAGE[15:0]}}

\rft {
    \rff {31$\,-\,$16} {16} {AIN1\_VOLTAGE} {0xFFFF} {$ V_{AIN1} $ voltage.} {\reflink{Table}{voltage-representation}}
    \rff {15$\,-\,$0} {16} {AIN0\_VOLTAGE} {0xFFFF} {$ V_{AIN0} $ voltage.} {\reflink{Table}{voltage-representation}}
}
{Analog data register 1}
{SM-ADR1}
...
\rmt
{\rmf{16}{|c|}{AIN3\_VOLTAGE[15:0]}}
{\rmf{16}{|c|}{AIN2\_VOLTAGE[15:0]}}

\rft {
    \rff {31$\,-\,$16} {16} {AIN3\_VOLTAGE} {0xFFFF} {$ V_{AIN3} $ voltage.} {\reflink{Table}{voltage-representation}}
    \rff {15$\,-\,$0} {16} {AIN2\_VOLTAGE} {0xFFFF} {$ V_{AIN2} $ voltage.} {\reflink{Table}{voltage-representation}}
}
{Analog data register 2}
{SM-ADR2}
...
\rmt
{\rmu{8}{|c} & \rmf{8}{|c|}{HUMIDITY[7:0]}}
{\rmu{4}{|c} & \rmf{12}{|c|}{TEMPERATURE[11:0]}}

\rft {
    \rfu {31$\,-\,$24} {8} {0x00}
    \rff {23$\,-\,$16} {8} {HUMIDITY} {0xFF} {Ambient humidity.} {\textbf{Raw} value in \%.}
    \rfu {15$\,-\,$12} {4} {0b0000}
    \rff {11$\,-\,$0} {12} {TEMPERATURE} {0x7FF} {Ambient temperature.} {\reflink{Table}{temperature-representation}}
}
...
\rft {
    \rfu {31$\,-\,$1} {31} {0b0[31]}
    \rff {0} {1} {RCFH} {$ - $} {Regulator control mode (set at compilation step according to hardware).} {\textbf{0b0} : Regulator controlled by the MCU. \\ \textbf{0b1} : Regulator controlled by hardware.}
}
{Flags register 1}
{RRM-FR1}
...
\rft {
    \rfu {31$\,-\,$2} {30} {0b0[30]}
    \rff {1$\,-\,$0} {2} {RCS} {0b11} {Regulator control state.} {\reflink{Table}{bit-representation} \\ \textbf{0b00} : Regulator output disabled. \\ \textbf{0b01} : Regulator output enabled.}
}
{Status register 1}
{RRM-SR1}
...
\rft {
    \rff {31$\,-\,$16} {16} {OUTPUT\_VOLTAGE} {0xFFFF} {Regulator output voltage.} {\reflink{Table}{voltage-representation}}
    \rff {15$\,-\,$0} {16} {INPUT\_VOLTAGE} {0xFFFF} {Regulator input voltage.} {\reflink{Table}{voltage-representation}}
}
{Analog data register 1}
{RRM-ADR1}
...
\rft {
    \rfu {31$\,-\,$16} {16} {0x0000}
    \rff {15$\,-\,$0} {16} {OUTPUT\_CURRENT} {0xFFFF} {Regulator output current.} {\reflink{Table}{current-representation}}
}
{Analog data register 2}
{RRM-ADR2}
...
{\rmf{8}{|c}{SIGFOX\_UL\_PERIOD[7:0]} & \rmf{8}{|c|}{NODE\_SCAN\_PERIOD[7:0]}}
...
\rft {
    ...
    \rff {7$\,-\,$0} {8} {NODE\_SCAN\_PERIOD} {$ - $} {Automatic node scanning period.} {\reflink{Table}{time-representation}}
}
{Configuration register 0}
{DMM-CFGR0}
...
\rmt
{\rmu{16}{|c|}}
{\rmu{8}{|c} & \rmf{8}{|c|}{NODE\_COUNT[7:0]}}

\rft {
    \rfu {31$\,-\,$8} {24} {0x000000}
    \rff {7$\,-\,$0} {8} {NODE\_COUNT} {$ - $} {Number of node(s) connected on the bus.} {\textbf{Raw} value.}
}
{Status register 1}
{DMM-SR1}
...
\rmt
{\rmf{16}{|c|}{HMI\_VOLTAGE[15:0]}}
{\rmf{16}{|c|}{RS485\_BUS\_VOLTAGE[15:0]}}

\rft {
    \rff {31$\,-\,$16} {16} {HMI\_VOLTAGE} {0xFFFF} {HMI voltage.} {\reflink{Table}{voltage-representation}}
    \rff {15$\,-\,$0} {16} {RS485\_BUS\_VOLTAGE} {0xFFFF} {RS485 bus power supply rail.} {\reflink{Table}{voltage-representation}}
}
{Analog data register 1}
{DMM-ADR1}
...
\rmt
{\rmu{16}{|c|}}
{\rmf{16}{|c|}{USB\_VOLTAGE[15:0]}}

\rft {
    \rfu {31$\,-\,$16} {16} {0x0000}
    \rff {15$\,-\,$0} {16} {USB\_VOLTAGE} {0xFFFF} {USB voltage.} {\reflink{Table}{voltage-representation}}
}
{Analog data register 2}
{DMM-ADR2}
...
\rmt
{\rmu{16}{|c|}}
{\rmf{8}{|c}{SHUNT\_RESISTOR} & \rmu{4}{|c} & \rmf{1}{|c}{BKFH} & \rmf{1}{|c}{CLFH} & \rmf{1}{|c}{CSFH} & \rmf{1}{|c|}{CCFH}}
...
\rft {
    \rfu {31$\,-\,$24} {8} {0x00}
    \rff {23$\,-\,$16} {8} {CHARGE\_TOGGLE\_PERIOD} {$ - $} {Charge toggle period.} {\reflink{Table}{time-representation}}
    \rff {15$\,-\,$0} {16} {CHARGE\_SOURCE\_VOLTAGE\_TH} {$ - $} {Minimum source voltage required to set the \texttt{CHEN} bit.} {\reflink{Table}{voltage-representation}}
}
{Configuration register 0}
{BCM-CFGR0}
...
\rmt
{\rmu{16}{|c|}}
{\rmu{6}{|c} & \rmf{1}{|c}{CVF} & \rmf{1}{|c}{LVF} &  \rmf{2}{|c}{CHST1} & \rmf{2}{|c}{CHST0} & \rmf{2}{|c}{CHCS} & \rmf{2}{|c|}{BKCS}}
...
\rft {
    ...
    \rff {7$\,-\,$6} {2} {CHST1} {0b11} {Battery charging status 1.} {\reflink{Table}{bit-representation} \\ See \reflink{table}{bcm-chrgst} for bit meaning.}
    \rff {5$\,-\,$4} {2} {CHST0} {0b11} {Battery charging status 0.} {\reflink{Table}{bit-representation} \\ See \reflink{table}{bcm-chrgst} for bit meaning.}
    \rff {3$\,-\,$2} {2} {CHCS} {0b11} {Battery charging control state.} {\reflink{Table}{bit-representation} \\ \textbf{0b00} : charge disabled. \\ \textbf{0b01} : charge enabled.}
    \rff {1$\,-\,$0} {2} {BKCS} {0b11} {Backup output control state.} {\reflink{Table}{bit-representation} \\ \textbf{0b00} : backup output disabled. \\ \textbf{0b01} : backup output enabled.}
}
{Status register 1}
{BCM-SR1}
...
\begin{table}[h]
    ...
    \begin{tabular}{|p{15mm}|p{15mm}|p{60mm}|}
        \tl\cellcolor{LightGray}\centering\texttt{CHST1} &
        \cellcolor{LightGray}\centering\texttt{CHST0} & \cellcolor{LightGray}\centering\textbf{Charge status} \tabularnewline
...
\rft {
    \rff {31$\,-\,$16} {16} {STORAGE\_VOLTAGE} {0xFFFF} {Battery voltage.} {\reflink{Table}{voltage-representation}}
    \rff {15$\,-\,$0} {16} {SOURCE\_VOLTAGE} {0xFFFF} {Input source voltage.} {\reflink{Table}{voltage-representation}}
}
{Analog data register 1}
{BCM-ADR1}
...
\rmt
{\rmf{16}{|c|}{CHARGE\_CURRENT[15:0]}}
{\rmf{16}{|c|}{BACKUP\_VOLTAGE[15:0]}}

\rft {
    \rff {31$\,-\,$16} {16} {CHARGE\_CURRENT} {0xFFFF} {Battery charge current.} {\reflink{Table}{current-representation}}
    \rff {15$\,-\,$0} {16} {BACKUP\_VOLTAGE} {0xFFFF} {Backup output voltage.} {\reflink{Table}{voltage-representation}}
}
{Analog data register 2}
{BCM-ADR2}
...
\rmt
{\rmu{16}{|c|}}
{\rmf{2}{|c}{R8ST} & \rmf{2}{|c}{R7ST} & \rmf{2}{|c}{R6ST} & \rmf{2}{|c}{R5ST} & \rmf{2}{|c}{R4ST} & \rmf{2}{|c}{R3ST} & \rmf{2}{|c}{R2ST} & \rmf{2}{|c|}{R1ST}}

\rft {
    \rfu {31$\,-\,$16} {16} {0x0000}
    \hline\cellcolor{PeachPuff}\centering\textbf{15$\,-\,$14} & \centering 2 & \centering\texttt{R8ST} & \centering 0b11 & \centering Relay 8 status. & \tabularnewline
    \cline{1-5}\cellcolor{PeachPuff}\centering\textbf{13$\,-\,$12} & \centering 2 & \centering\texttt{R7ST} & \centering 0b11 & \centering Relay 7 status. & \centering \tabularnewline
    \cline{1-5}\cellcolor{PeachPuff}\centering\textbf{11$\,-\,$10} & \centering 2 & \centering\texttt{R6ST} & \centering 0b11 & \centering Relay 6 status. & \centering \reflink{Table}{bit-representation} \tabularnewline
    \cline{1-5}\cellcolor{PeachPuff}\centering\textbf{9$\,-\,$8} & \centering 2 & \centering\texttt{R5ST} & \centering 0b11 & \centering Relay 5 status. & \centering \tabularnewline
    \cline{1-5}\cellcolor{PeachPuff}\centering\textbf{7$\,-\,$6} & \centering 2 & \centering\texttt{R4ST} & \centering 0b11 & \centering Relay 4 status. & \centering \textbf{0b0} : NC path closed \tabularnewline
    \cline{1-5}\cellcolor{PeachPuff}\centering\textbf{5$\,-\,$4} & \centering 2 & \centering\texttt{R3ST} & \centering 0b11 & \centering Relay 3 status. & \centering \textbf{0b1} : NO path closed \tabularnewline
    \cline{1-5}\cellcolor{PeachPuff}\centering\textbf{3$\,-\,$2} & \centering 2 & \centering\texttt{R2ST} & \centering 0b11 & \centering Relay 2 status. & \tabularnewline
    \cline{1-5}\cellcolor{PeachPuff}\centering\textbf{1$\,-\,$0} & \centering 2 & \centering\texttt{R1ST} & \centering 0b11 & \centering Relay 1 status. & \tabularnewline
}
{Status register}
{R4S8CR-SR}
...
\rmt
{\rmu{16}{|c|}}
{\rmu{8}{|c} & \rmf{1}{|c}{R8C} & \rmf{1}{|c}{R7C} & \rmf{1}{|c}{R6C} & \rmf{1}{|c}{R5C} & \rmf{1}{|c}{R4C} & \rmf{1}{|c}{R3C} & \rmf{1}{|c}{R2C} & \rmf{1}{|c|}{R1C}}

\rft {
    \rfu {31$\,-\,$8} {24} {0x000000}
    \hline\cellcolor{PeachPuff}\centering\textbf{7} & \centering 1 & \centering\texttt{R8C} & \centering 0b0 & \centering Relay 8 control. & \tabularnewline
    \cline{1-5}\cellcolor{PeachPuff}\centering\textbf{6} & \centering 1 & \centering\texttt{R7C} & \centering 0b0 & \centering Relay 7 control. & \centering \tabularnewline
    \cline{1-5}\cellcolor{PeachPuff}\centering\textbf{5} & \centering 1 & \centering\texttt{R6C} & \centering 0b0 & \centering Relay 6 control. & \centering \tabularnewline
    \cline{1-5}\cellcolor{PeachPuff}\centering\textbf{4} & \centering 1 & \centering\texttt{R5C} & \centering 0b0 & \centering Relay 5 control. & \centering \textbf{0b0} : close NC path \tabularnewline
    \cline{1-5}\cellcolor{PeachPuff}\centering\textbf{3} & \centering 1 & \centering\texttt{R4C} & \centering 0b0 & \centering Relay 4 control. & \centering \textbf{0b1} : close NO path \tabularnewline
    \cline{1-5}\cellcolor{PeachPuff}\centering\textbf{2} & \centering 1 & \centering\texttt{R3C} & \centering 0b0 & \centering Relay 3 control. & \centering \tabularnewline
    \cline{1-5}\cellcolor{PeachPuff}\centering\textbf{1} & \centering 1 & \centering\texttt{R2C} & \centering 0b0 & \centering Relay 2 control. & \tabularnewline
    \cline{1-5}\cellcolor{PeachPuff}\centering\textbf{0} & \centering 1 & \centering\texttt{R1C} & \centering 0b0 & \centering Relay 1 control. & \tabularnewline
}
{Control register}
{R4S8CR-CR}
