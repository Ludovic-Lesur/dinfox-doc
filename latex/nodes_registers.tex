...
\rft {
    \rff {31$\,-\,$0} {32} {TP\_FREQUENCY} {0x00989680} {Timepulse signal frequency.} {\textbf{Raw} value in $ Hz $. \\ (1 to 10000000)}
}
{Configuration register 1}
{GPSM-CFGR1}
...
\rft {
    \rfu {31$\,-\,$7} {25} {0b0[25]}
    \rff {6$\,-\,$0} {7} {TP\_DUTY\_CYCLE} {0x32} {Timepulse signal duty cycle.} {\textbf{Raw} value in \% \\ (0 to 100)}
}
{Configuration register 2}
{GPSM-CFGR2}
